...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-envelope"></i> Memo</li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-3">
              <button type="button" class="btn btn-primary btn-block margin-bottom" data-toggle="modal" data-target="#AddMemo">
                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Create Memo
              </button>
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="#"><i class="fa fa-inbox"></i>Memo <span class="label label-primary pull-right"><?php echo $notif; ?></span></a></li>
            ...
            <div class="col-md-9">
              <div class="box box-primary">
                ...
                <div class="box-body no-padding">
                  ...
                  <div class="table-responsive mailbox-messages" id="memo">
      ...
      <form method="post">  
      <div class="modal modal-primary fade" id="AddMemo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog modal-sm" role="document">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" rows="3" name="Title" id="Title"placeholder="Create Memo" required>
            </div>
<br>
            <div class="input-group">
              <label>Content</label>
              <textarea name="memo_content" class="form-control" rows="10" required></textarea>
            </div>
            
                  </div>
                  <div class="modal-footer">
                      <button type="submit" class="btn btn-info " name ="add_memo" id ="add_memo">Create</button> 
                  </div>
              </div>
          </div>
      </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Memo Content</h4>
        </div>
