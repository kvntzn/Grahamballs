					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown" ><a href="view_product.php" class="active">Shop<i class="fa fa-angle-down"></i></a>
	...
	<section>
		<div class="container">
					...
					<div class="features_items"><!--features_items-->
						...
						$idget=mysqli_query($conn,"SELECT cus_id FROM tbl_customer Where cus_uname='$userx' ");
		 			 	...
		 			 	$userid = $row['cus_id'];
		 			 							...
		 			 							$get=mysqli_query($conn,"SELECT * FROM tbl_stocks where  stock_quantity >0 ");
								                 while($query=mysqli_fetch_array($get))
								                      { ?>
						<div class="col-sm-4">
		  ...
		  <?php  
		   $limit=10;
		   $page=1;
            $rows=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM tbl_stocks"));
