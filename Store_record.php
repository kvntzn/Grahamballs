      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><i class="fa fa-building"></i> <a href="#">Stores</a></li>
        ...
        <section class="content">
          ...
          <button type="button" class="btn btn-info btn-flat margin-bottom" data-toggle="modal" data-target="#AddPModal">
                <span class="fa fa-building" aria-hidden="true"></span> Add Stores
              </button>
              <?php } ?>
          <!-- Default box -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Store Records</h3>
